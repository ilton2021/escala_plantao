														 ...
														 <input type="hidden" name="_token" value="{{ csrf_token() }}">
															...
															<table class="table table-hover m-b-0 without-header">	  
																<tr>
																 ...
																 <td colspan="2"><center><b>Centro de Custo: {{ $funcionarios[0]->centro_custo  }}</b></center></td>
																</tr>
																<tr>
															      ...
															      <?php $b = 0; ?>
																  <?php for($a = 1; $a < 32; $a++){ ?>
																	<td><center><a href="{{ route('frequenciaEscala_novo', array($escala[0]->escala_id,$funcionarios[0]->centro_custo_id,$a)) }}">{{ $a }} </a></center></td>
																  <?php } ?> 
																<tr>  
																@foreach($frequencia as $func) <?php $b += 1; ?>
																  ...
																  <tr>
																	...
																	@if($func->funcionario_id == $fc->id)
																	<td>
																	<input readonly="true" type="text" style="width:150px" class="form-control" id="cargo_<?php echo $b ?>" name="cargo_<?php echo $b ?>" value="<?php echo $fc->cargo; ?>" title="<?php echo $fc->cargo; ?>" />
																	</td>
																	@endif
																	@endforeach
																	@foreach($funcionarios as $fc)
