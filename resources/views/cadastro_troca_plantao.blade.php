...
<html lang="pt">
<head>
    <title>Cadastro Troca de Plantão</title>
    <meta charset="utf-8">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Cadastro Troca de Plantão</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('cadastroTrocaP') }}">Cadastro Troca de Plantão</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="table-responsive">
                                                            <table class="table table-hover m-b-0 without-header">
																<tbody>
																<td><a href="{{ route('novaTrocaP') }}" class="btn btn-sm btn-success">Cadastrar Troca de Plantão +</a></td>
																<td><a href="{{ route('visualizarTrocaP') }}" class="btn btn-sm btn-info">Visualizar Troca de Plantão <i class="fa-search"></i></a></td>
                                                                </tbody>
                                                            </table>
                                                        </div>
                                                    </div>
