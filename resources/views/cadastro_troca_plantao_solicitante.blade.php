											  ...
											  <a href="{{ route('cadastroTrocaP') }}" class="btn btn-warning btn-sm">Voltar</a>
                                             	<div class="card table-card">
                                                 	<div class="card-header">
                                                        <h5>Autorização para Troca de Plantão:</h5>
                                                        ...
                                                        <div class="table-responsive">
														 ...
														 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <table class="table table-hover m-b-0 without-header">
                                                                <thead>
																  <tr>
																 	<td style="width: 500px;"> Solicitante: </td>
																	<td> Matrícula: </td>
																	<td> Setor: </td>
																  </tr>
																  <tr>
																   <td colspan="1"> <input type="text" required="true" class="form-control" id="nome" name="nome" value="<?php echo $funcionarioSol[0]->nome; ?>" readonly="true" /> </td>
																   <td> <input type="text" required="true" class="form-control" id="matricula" name="matricula" value="<?php echo $funcionarioSol[0]->matricula; ?>" readonly="true" /> </td>
																   <td> <input type="text" required="true" class="form-control" id="setor" name="setor" value="<?php echo $funcionarioSol[0]->cargo; ?>" readonly="true" /> </td>
																  </tr>
																</thead>
															...
															<table class="table table-hover m-b-0 without-header">
                                                                <thead>
																  <tr>
																 	<td style="width: 500px;"> Substituto: </td>
																	<td> Matrícula: </td>
																	<td> Setor: </td>
																  </tr>
																  <tr>
																   <td colspan="1"> <input type="text" required="true" class="form-control" id="nome" name="nome" value="<?php echo $funcionarioSub[0]->nome; ?>" readonly="true" /> </td>
																   <td> <input type="text" required="true" class="form-control" id="matricula" name="matricula" value="<?php echo $funcionarioSub[0]->matricula; ?>" readonly="true" /> </td>
																   <td> <input type="text" required="true" class="form-control" id="setor" name="setor" value="<?php echo $funcionarioSub[0]->cargo; ?>" readonly="true" /> </td>
																  </tr>
																</thead>
																<tbody>
																  <tr>
																  ...
																  <tr> <?php $mes = date('m', strtotime('now')); $ano = date('Y', strtotime('now')); ?>
																   <td>
																    <input class="form-control" type="text" readonly="true" id="dia" name="dia" value="<?php echo $d; ?>" style="width: 100px;"> 
																   </td>
																   <td> <input type="text" class="form-control" readonly="true" id="mes_ano" name="mes_ano" value="<?php echo $mes .'/'. $ano; ?>" /> </td>	
																   <td> 
																   @if($funcionarioSol[0]->tipo_plantao == "D")
																  ...
																  <tr>
																   <input hidden type="text" class="form-control" id="colaborador" name="colaborador" value="<?php echo $funcionarioSol[0]->id; ?>" />
																   <input hidden type="text" class="form-control" id="substituto" name="substituto" value="<?php echo $funcionarioSub[0]->id; ?>" />
																   <input hidden type="text" class="form-control" id="gestor" name="gestor" value="" />
																   <input hidden type="text" class="form-control" id="escala_id" name="escala_id" value="" />
