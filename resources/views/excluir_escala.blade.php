                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Excluir Escala</h5>
                                    ...
                                    <div class="col-md-4">
									  <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('excluirEscala', $escalas[0]->id) }}">Excluir Escala</a>
                                        </li>
									  </ul>
                                    </div>
                                </div>
                                             	...
                                             	<div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="table-responsive">
														 <form action="{{\Request::route('deleteEscala')}}" method="post">
														 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <table class="table table-hover m-b-0 without-header">
																...
																<tbody>
																  <tr>
																   <td><input type="text" disabled="true" class="form-control" id="descricao" name="descricao" value="<?php echo $escalas[0]->mes ."/". $escalas[0]->ano; ?>" /></td>
																   <td><input type="text" disabled="true" class="form-control" id="centro_custo" name="centro_custo" value="<?php echo $escalas[0]->centro_custo; ?>" /></td>
																  </tr>
																  <tr>
																   <td colspan="2" align="right">Deseja realmente excluir esta Escala?</td>
																  </tr>
																  <tr>
																   <td colspan="2" align="right"><input type="submit" class="btn btn-danger btn-sm" style="margin-top: 10px;" value="Excluir" id="Salvar" name="Salvar" /> </td>
																  </tr>
															    </tbody>
                                                            </table>
														 </form>
