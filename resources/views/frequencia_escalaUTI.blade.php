...
<html lang="pt">
<head>
    <title>Frequência de Escala</title>
    <meta charset="utf-8">
            ...
            <nav class="navbar header-navbar pcoded-header">
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        ...
                        <a href="{{ route('index') }}">
                           <p style="margin-left: 30px"> Frequência de Escala </p>
                        </a>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Nova Freqência de Escala</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            @if($qtd > 0)
											<li class="breadcrumb-item"><a href="{{ route('novaEscala', $escala[0]->id) }}">Nova Frequência de Escala</a></li>
											@endif
                                        </ul>
                                    </div>
                                </div>
											  ...
											  <a href="{{ route('cadastroEscala') }}" class="btn btn-warning btn-sm">Voltar</a>
                                             	<div class="card table-card">
                                                 	<div class="card-header">
                                                        <h5>Nova Frequência de Escala:</h5>
                                                            ...
                                                            <table class="table table-hover m-b-0 without-header">
																...
																@if($qtd > 0)
																 @foreach($centro_custo as $cc)
																  <tr>
																   <td>{{ $cc->descricao }}</td>
																   <td><a href="{{ route('frequenciaEscalaUTI_novo', array($escala[0]->id,$cc->id)) }}" class="btn btn-sm btn-success">CADASTRAR</a></td>
                                                                   <td><a href="{{ route('visualizarFrequenciaUTI', array($escala[0]->id,$cc->id)) }}" class="btn btn-sm btn-dark">VISUALIZAR</a></td>
																  </tr>
																 @endforeach
																@endif
                                                                </tbody>
