                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Cadastro Escala</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('cadastroEscala') }}">Cadastro Escala</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                           <div class="col-xl-14 col-md-18">
												@if (Session::has('mensagem'))
													...
													@endif
												@endif
                                                <a href="{{ route('novaEscalaMesAno') }}" class="btn btn-sm btn-success">Nova Escala +</a>
