	...
	<script type="text/javascript">
            function habilitar(valor) { 
                <?php  
				    ...
				    for($f = 1; $f <= $qtd; $f++) { ?>
						var a = document.getElementById('todos_<?php echo $f ?>').checked; 
						var b = document.getElementById('escala_<?php echo $f ?>').value;
						if(a == true && b == "ÍMPAR") { 
							document.getElementById('dia1_<?php echo $f ?>').checked = true; document.getElementById('dia3_<?php echo $f ?>').checked = true; document.getElementById('dia5_<?php echo $f ?>').checked = true; document.getElementById('dia7_<?php echo $f ?>').checked = true;	
							document.getElementById('dia9_<?php echo $f ?>').checked = true; document.getElementById('dia11_<?php echo $f ?>').checked = true; document.getElementById('dia13_<?php echo $f ?>').checked = true; document.getElementById('dia15_<?php echo $f ?>').checked = true;	
							document.getElementById('dia17_<?php echo $f ?>').checked = true; document.getElementById('dia19_<?php echo $f ?>').checked = true;	document.getElementById('dia21_<?php echo $f ?>').checked = true; document.getElementById('dia23_<?php echo $f ?>').checked = true;	
							document.getElementById('dia25_<?php echo $f ?>').checked = true; document.getElementById('dia27_<?php echo $f ?>').checked = true;	document.getElementById('dia29_<?php echo $f ?>').checked = true; document.getElementById('dia31_<?php echo $f ?>').checked = true;	
						} else if (a == false && b == "ÍMPAR"){
							document.getElementById('dia1_<?php echo $f ?>').checked = false; document.getElementById('dia3_<?php echo $f ?>').checked = false;	document.getElementById('dia5_<?php echo $f ?>').checked = false; document.getElementById('dia7_<?php echo $f ?>').checked = false;	
							document.getElementById('dia9_<?php echo $f ?>').checked = false; document.getElementById('dia11_<?php echo $f ?>').checked = false; document.getElementById('dia13_<?php echo $f ?>').checked = false;	document.getElementById('dia15_<?php echo $f ?>').checked = false;	
							document.getElementById('dia17_<?php echo $f ?>').checked = false; document.getElementById('dia19_<?php echo $f ?>').checked = false; document.getElementById('dia21_<?php echo $f ?>').checked = false; document.getElementById('dia23_<?php echo $f ?>').checked = false;	
							document.getElementById('dia25_<?php echo $f ?>').checked = false; document.getElementById('dia27_<?php echo $f ?>').checked = false; document.getElementById('dia29_<?php echo $f ?>').checked = false; document.getElementById('dia31_<?php echo $f ?>').checked = false;	
						}
						if(a == true && b == "PAR") { 
							document.getElementById('dia2_<?php echo $f ?>').checked = true; document.getElementById('dia4_<?php echo $f ?>').checked = true; document.getElementById('dia6_<?php echo $f ?>').checked = true; document.getElementById('dia8_<?php echo $f ?>').checked = true;	
							document.getElementById('dia10_<?php echo $f ?>').checked = true; document.getElementById('dia12_<?php echo $f ?>').checked = true;	document.getElementById('dia14_<?php echo $f ?>').checked = true; document.getElementById('dia16_<?php echo $f ?>').checked = true;	
							document.getElementById('dia18_<?php echo $f ?>').checked = true; document.getElementById('dia20_<?php echo $f ?>').checked = true;	document.getElementById('dia22_<?php echo $f ?>').checked = true; document.getElementById('dia24_<?php echo $f ?>').checked = true;	
							document.getElementById('dia26_<?php echo $f ?>').checked = true; document.getElementById('dia28_<?php echo $f ?>').checked = true;	document.getElementById('dia30_<?php echo $f ?>').checked = true;	
						} else if (a == false && b == "PAR"){
							document.getElementById('dia2_<?php echo $f ?>').checked = false; document.getElementById('dia4_<?php echo $f ?>').checked = false;	document.getElementById('dia6_<?php echo $f ?>').checked = false; document.getElementById('dia8_<?php echo $f ?>').checked = false;	
							document.getElementById('dia10_<?php echo $f ?>').checked = false; document.getElementById('dia12_<?php echo $f ?>').checked = false; document.getElementById('dia14_<?php echo $f ?>').checked = false; document.getElementById('dia16_<?php echo $f ?>').checked = false;	
							document.getElementById('dia18_<?php echo $f ?>').checked = false; document.getElementById('dia20_<?php echo $f ?>').checked = false; document.getElementById('dia22_<?php echo $f ?>').checked = false; document.getElementById('dia24_<?php echo $f ?>').checked = false;	
							document.getElementById('dia26_<?php echo $f ?>').checked = false; document.getElementById('dia28_<?php echo $f ?>').checked = false; document.getElementById('dia30_<?php echo $f ?>').checked = false;	
						}
           <?php    } ?>  
		    } 
    </script>					
														 ...
														 <input type="hidden" name="_token" value="{{ csrf_token() }}">
															...
															<table class="table table-hover m-b-0 without-header">	  
																...
																<tr>
																  ...
																  <td><center>Marcar Todos</center></td>
															      <?php for($a = 1; $a < 32; $a++){ ?>
																...
																@foreach($funcionarios as $func)
																  ...
																  <tr>
																	...
																	<td hidden>
																	 <input type="text" readonly="true" style="width:70px" class="form-control" id="escala_<?php echo $b ?>" name="escala_<?php echo $b ?>" value="<?php if($func->escala == "I"){ echo "ÍMPAR"; }else{ echo "PAR"; }  ?>" required="true" />
																	</td>
																	<td>
																	 <input type="checkbox" id="todos_<?php echo $b ?>" name="todos_<?php echo $b ?>" class="form-control" onchange="habilitar('sim')">	
																	</td>
																	<td>
