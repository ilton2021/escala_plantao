                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Excluir Funcionário</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('excluirFunc', $funcionario[0]->id) }}">Excluir Funcionário</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="table-responsive">
														 ...
														 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <table class="table table-hover m-b-0 without-header">
																...
																<tbody>
																  <tr>
																   <td><input type="text" disabled="true" class="form-control" id="nome" name="nome" value="<?php echo $funcionario[0]->nome; ?>" /></td>
																  </tr>
																  <tr>
																   <td align="right">Deseja realmente excluir este Funcionário?</td>
																  </tr>
																  <tr>
