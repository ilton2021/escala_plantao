...
<html lang="pt">
<head>
    <title>Cadastro Centro de Custo</title>
    <meta charset="utf-8">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Cadastro Centro de Custo</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('cadastroCentroC') }}">Cadastro Centro de Custo</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                           <div class="col-xl-6 col-md-12">
												@if (Session::has('mensagem'))
													...
													@endif
												@endif
                                                <a href="{{ route('novoCentroC') }}" class="btn btn-sm btn-success">Novo Centro de Custo +</a>
																...
																@if($qtd > 0)
																 @foreach($centro_custo as $cc)
																  <tr>
																   <td>{{ $cc->id }}</td>
																   <td>{{ $cc->descricao }}</td>
																   <td><a href="{{ route('alterarCentroC', $cc->id) }}" class="btn btn-sm btn-info">ALTERAR</a></td>
																   <td><a href="{{ route('excluirCentroC', $cc->id) }}" class="btn btn-sm btn-danger">EXCLUIR</a></td>
																  </tr>
																 @endforeach
																@endif
                                                                </tbody>
