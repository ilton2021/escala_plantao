                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Novo Centro de Custo</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('novoCentroC') }}">Novo Centro de Custo</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                             	...
                                             	<div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="table-responsive">
														 <form action="{{\Request::route('storeCentroCusto')}}" method="post">
														 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <table class="table table-hover m-b-0 without-header">
																...
																<tbody>
																  <tr>
																   <td><input type="text" required="true" class="form-control" id="descricao" name="descricao" value="" /></td>
																  </tr>
																  <tr>
																   <td align="right"><input type="submit" class="btn btn-success btn-sm" style="margin-top: 10px;" value="Salvar" id="Salvar" name="Salvar" /> </td>
																  </tr>
															    </tbody>
                                                            </table>
														 </form>
