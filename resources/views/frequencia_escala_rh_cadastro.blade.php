                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('frequenciaEscalaRH_cadastro') }}">Visualizar Escala</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                            ...
                                                            <table class="table table-hover m-b-0 without-header">
																...
																@foreach($escalas as $escala)
																  <tr>
																   ...
																   <td><a href="{{ route('frequenciaEscalaRH', $escala->id) }}" class="btn btn-sm btn-dark">VISUALIZAR ESCALA</a></td>
																  </tr>
																@endforeach
															    </tbody>
                                                            </table>
