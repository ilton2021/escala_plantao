...
<html lang="pt">
<head>
    <title>Excluir Centro de Custo</title>
    <meta charset="utf-8">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Excluir Centro de Custo</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ route('excluirCentroC', $centro_custo[0]->id) }}">Excluir Centro de Custo</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                             	...
                                             	<div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="table-responsive">
														 <form action="{{\Request::route('deleteCentroCusto')}}" method="post">
														 <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                                            <table class="table table-hover m-b-0 without-header">
																...
																<tbody>
																  <tr>
																   <td><input type="text" disabled="true" class="form-control" id="descricao" name="descricao" value="<?php echo $centro_custo[0]->descricao; ?>" /></td>
																  </tr>
																  <tr>
																   <td align="right">Deseja realmente excluir este Centro de Custo?</td>
																  </tr>
																  <tr>
																   <td align="right"><input type="submit" class="btn btn-danger btn-sm" style="margin-top: 10px;" value="Excluir" id="Salvar" name="Salvar" /> </td>
																  </tr>
															    </tbody>
                                                            </table>
														 </form>
